...
class CannotPlayMatchesExceptionHandler implements ExceptionHandler
{
    ...
    public function handle(Throwable $exception, Request $request): JsonResponse|null
    {
        ...
        /** @var CannotPlayMatchesException $exception */
    ...
    {
        return $exception instanceof CannotPlayMatchesException && $this->isApiRequest($request);
    }
}
